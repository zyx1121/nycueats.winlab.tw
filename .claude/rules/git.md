...
v0.2.0 — 訂單流程補完（紀錄、狀態、領餐）   ← 已完成
v0.3.0 — 餐點推薦引擎                       ← 已完成
v0.4.0 — 管理員後台                         ← 已完成
v0.5.0 — 測試與錯誤處理                     ← 已完成
v1.0.0 — 基本需求全部完成                   ← 進行中（領餐配送標籤列印未完成）
```

> 註：v0.2–v0.5 的功能均已 ship，但 `package.json` 仍為 `0.1.0`、尚未打 git tag 或建 GitHub Milestone。正式發布時補上版號與 tag。
