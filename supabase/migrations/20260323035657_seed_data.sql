...
select '11111111-0000-0000-0000-000000000001'::uuid, id from areas where name = '新竹光復校區'
union all
select '11111111-0000-0000-0000-000000000002'::uuid, id from areas where name = '新竹光復校區'
union all
select '11111111-0000-0000-0000-000000000003'::uuid, id from areas where name = '新竹光復校區'
union all
select '11111111-0000-0000-0000-000000000001'::uuid, id from areas where name = '新竹博愛校區';
